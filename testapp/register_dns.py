...
Environment variables (all optional — sensible defaults provided):
    ...
    SERVICE_SUBDOMAIN    – subdomain to register             (testapp)
...
SUBDOMAIN = os.environ.get("SERVICE_SUBDOMAIN", "testapp")
...
def main() -> None:
    ...
    if ok:
        ...
        print(f"[register] WARNING: registration failed – continuing anyway.")
