#!/usr/bin/env python3
"""Register this app as a service in re-ddns.
...
Environment variables (all optional — sensible defaults provided):
    ...
    SERVICE_SUBDOMAIN    – subdomain to register             (from APP_NAME)
...
SUBDOMAIN = os.environ.get("SERVICE_SUBDOMAIN", os.environ.get("APP_NAME", "myapp"))
